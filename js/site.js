(function () {
  ...
  function replaceSiteFooterWithHomeFooter() {
    ...
    footer.innerHTML =
      ...
      '      <a class="footer-brand" href="/" aria-label="Salmart Diplomatic Hospitality">' +
      '        <picture>' +
      '          <source media="(max-width: 980px)" srcset="/img/salmart-diplomatic-hospitality-logo.png" />' +
      '          <img src="/img/salmart-logo.png" alt="Salmart Diplomatic Hospitality" decoding="async" loading="lazy" />' +
      '        </picture>' +
      '      </a>' +
      '' +
      ...
      '        <ul class="footer-links">' +
      '          <li><a href="/services">Event Management &amp; Production</a></li>' +
      '          <li><a href="/services">Branding &amp; Venue Transformation</a></li>' +
      '          <li><a href="/services">Protocol &amp; Diplomatic Services</a></li>' +
      '          <li><a href="/services">Luxury Accommodation &amp; Logistics</a></li>' +
      '          <li><a href="/storytelling">Media &amp; Strategic Storytelling</a></li>' +
      '        </ul>' +
      '      </div>' +
      '' +
  ...
  function setupTopbarPhoneAndCleanup() {
    ...
    // Footer is rendered server-side by Blade partial; skip JS injection.
  ...
  function removeLinksToMissingPages() {
    ...
    var removed = {
      "/service-production-branding-venue": true,
      "/service-conference-support-coverage": true,
      "/service-luxury-accommodation-logistics": true,
      "/service-cultural-tourism-experiences": true,
      "/department-creative-production-unit": true,
    };
  ...
  function hydrateMegaMenus() {
    ...
    var serviceLinksByCol = [
      [
        { href: "/service-event-management-production", label: "Event Management Services" },
        { href: "/service-mice-delivery", label: "MICE Services" },
        { href: "/service-protocol-diplomatic", label: "Protocol & Diplomatic Services" },
      ],
      [
        { href: "/service-destination-management-hospitality", label: "Destination Management & Hospitality" },
        { href: "/service-tours-experiences", label: "Tours & Experiences Services" },
        { href: "/service-sports-tourism-services", label: "Sports Tourism Services" },
      ],
      [
        { href: "/service-cruise-line-services", label: "Cruise Line Services" },
        { href: "/service-maritime-services", label: "Maritime Services" },
        { href: "/service-media-management-strategic-storytelling", label: "Media Management Services" },
      ],
    ];

    var departmentLinksByCol = [
      [
        { href: "/department-business-development-partnerships", label: "Business Development & Partnerships" },
        { href: "/department-tours-experiences", label: "Tours & Experiences" },
        { href: "/department-destination-management-hospitality", label: "Destination Management & Hospitality" },
        { href: "/department-event-conference-management", label: "Event & Conference Management" },
        { href: "/department-protocol-diplomatic-services", label: "Protocol & Diplomatic Services" },
      ],
      [
        { href: "/department-media-communications", label: "Media & Communications" },
        { href: "/department-strategic-affairs-scientific-engagement", label: "Strategic Affairs & Government Engagement" },
        { href: "/department-training-capacity-building", label: "Training & Capacity Building" },
        { href: "/department-finance-administration", label: "Finance & Administration" },
      ],
    ];
  ...
  function markActiveLinks() {
    ...
    var isDeptDetail = /^\/department-/.test(path);
    var isPortfolioDetail = /^\/portfolio-detail-/.test(path);
    ...
    applyActive(navLinks, normalizedPath);

    if (isServiceDetail)   { applyActive(navLinks, "/services"); }
    if (isDeptDetail)      { applyActive(navLinks, "/departments"); }
    if (isPortfolioDetail) { applyActive(navLinks, "/portfolio"); }
  }
